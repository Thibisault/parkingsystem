...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareReudctionCarEntryOneTime() throws SQLException, ClassNotFoundException {
        ...
        Ticket ticket = preparationJeuDeBase.createTicketWithRegNumber150Number1("600");
        ...
        ticket.setParkingSpot(parkingSpot);
        fareCalculatorService.calculateFare(ticket);
        assertEquals(df.format(1.5d*0.95d), df.format(ticket.getPrice()));
    }
